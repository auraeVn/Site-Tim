...
// CONDITION POUR BIO
        ...
        if(contenu.id === "Bio"){
              imgcenter.classList.toggle("section1center");
        }
        ...
        switch (contenu.id) {
          ...
          case '3 Fantômes sur une poussière':
            ...
            gridThreeCols.innerHTML = `
              <img class="image2-3" src="${contenu.image2}">
              <img class="image3-3" src="${contenu.image3}">
              <img class="image4-3" src="${contenu.image4}">
            `;
            break;
